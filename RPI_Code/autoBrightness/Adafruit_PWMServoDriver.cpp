...
*/
  wiringPiI2CWriteReg16(_fd,PCA9685_LED0_ON_L + 4 * num,on);
  wiringPiI2CWriteReg16(_fd,PCA9685_LED0_ON_L + 4 * num + 2,off);
}
...
void Adafruit_PWMServoDriver::write8(uint8_t addr, uint8_t d) {
  wiringPiI2CWriteReg8(_fd,addr,d);
}
